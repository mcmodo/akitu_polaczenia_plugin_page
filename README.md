...
- [2. Wymagania i warstwy wymagane](#wymagania-warstwy)
- [3. Pasek narzędzi formularza](#pasek-narzedzi)
- [4. Zakładka: Włókno–Włókno](#tab-ww)
- [5. Zakładka: Splitter (Włókno/Pigtail–Splitter)](#tab-ws)
- [6. Zakładka: Włókno–Pigtail](#tab-wp)
- [7. Zakładka: Pigtail–Pigtail](#tab-pp)
- [8. Zakładka: Pigtail–Włókno](#tab-pw)
- [9. Zakładka: Pigtail–Device](#tab-pd)
- [10. Zakładka: Device–Device](#tab-dd)
- [11. Wspólne zasady walidacji i statusy](#walidacja-statusy)
...
<a id="rozwiazywanie-problemow"></a>
## 12. Rozwiązywanie problemów

| Objaw | Prawdopodobna przyczyna | Rozwiązanie |
|---|---|---|
| Formularz nie otwiera się / komunikat o brakującej warstwie | W projekcie QGIS brakuje jednej z wymaganych warstw (zob. [rozdział 2](#wymagania-warstwy)) lub brakuje w niej wymaganego pola | Dodaj/popraw warstwę i jej pola, uruchom wtyczkę ponownie |
